...
class Scanwedge {
  ...
  @Deprecated(
      'This is for backwards compatibility, use [createScanProfile] instead, honeywell will throw exception if this is called')
  ...
  /// ```
  /// For more info on the commands go to <https://techdocs.zebra.com/datawedge/latest/guide/api/setconfig>
  Future<bool> sendCommandBundle(
          {required String command, required Map<String, dynamic> parameter, bool sendResult = false}) =>
